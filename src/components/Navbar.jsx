    ...
    <nav className="flex flex-col h-full w-[86px] bg-background border-r border-border shrink-0">
      <div className="flex flex-col items-center justify-between w-full h-full px-[11px] py-[24px]">
        ...
        <div className="flex flex-col items-center gap-3">
          <button className="flex items-center justify-center rounded-lg p-2 transition-opacity hover:opacity-70 text-muted-foreground" aria-label="Log out">
          ...
          <div className="flex items-center justify-center rounded-full w-[34px] h-[34px] bg-primary text-primary-foreground font-semibold text-[12px]">
            MR
          </div>
        </div>
